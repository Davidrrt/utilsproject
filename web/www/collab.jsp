...
<%@page import="mg.itu.utilproject.modele.Participant"%>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <br>
                    <div class="col-lg-10">
                       <% List<Participant> note = (List<Participant>) request.getAttribute("sheet");%>
                       <table class="table">
                           <thead>
                               <tr>
                                   <th>Nom</th>
                           ...
                           <tbody>
                               ...
                               <tr>
                                   <td><% out.print(note.get(i).getNommembres()); %></td>
                                   <td><% out.print(note.get(i).getPrenommembres()); %></td>
                                   <td><a href="single?idcol=<% out.print(note.get(i).getId()); %>&idpro=<% out.print(request.getParameter("idpro")); %>">Afficher</a></td>
                               </tr>
                               <%} %>
                           </tbody>
                       </table>
